  ...
  function renderRevenueMixChart(viewModel) {
    ...
    chart.setOption({
      ...
      tooltip: {
        ...
        formatter: parameter => `<strong>${escapeHtml(parameter.name)}</strong><br/><span style="color:#c7c2e8">Gross revenue</span>&nbsp;&nbsp;${fullMoney(parameter.value)}<br/><span style="color:#c7c2e8">Revenue share</span>&nbsp;&nbsp;${percent(parameter.percent)}`
      },
      series: [{
